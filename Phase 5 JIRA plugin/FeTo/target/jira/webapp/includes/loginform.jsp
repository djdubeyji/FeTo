            ...
            <aui:param name="'messageHtml'">
                <p>
                    <ww:text name="'jira.recoverymode.login.message'">
                        ...
                        <ww:param name="'value1'"><a target="_blank" rel="noopener noreferrer" href="<ww:help-url key="recovery-mode"/>"></ww:param>
        ...
        <%
            if (isMobileAppRequest) { %>
                <page:applyDecorator name="auifieldgroup">
                    <input class="text medium-field" id="login-form-username" aria-describedby="login-form-error" name="os_username" placeholder="<ww:text name="'alt.text.username.placeholder'"/>" type="text" value="<ww:property value="$os_username" />" />
                </page:applyDecorator>

                <page:applyDecorator name="auifieldgroup">
                    <input id="login-form-password" class="text medium-field" name="os_password" placeholder="<ww:text name="'alt.text.password.placeholder'"/>" type="password" />
                </page:applyDecorator>
                <input type="hidden" name="os_cookie" value="<%=allowCookies%>">
            <% } else { %>
                <page:applyDecorator name="auifieldgroup">
                    <label accesskey="<ww:text name="'alt.text.username.accessKey'"/>" for="login-form-username"><ww:text name="'alt.text.username'"/></label>
                    <input class="text medium-field" id="login-form-username" name="os_username" type="text" aria-describedby="login-form-error" value="<ww:property value="$os_username" />" />
                </page:applyDecorator>
