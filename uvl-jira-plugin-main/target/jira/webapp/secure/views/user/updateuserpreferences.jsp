        ...
        <page:applyDecorator name="auifieldset">
            ...
            <page:applyDecorator name="auifieldgroup">
                ...
                <page:applyDecorator name="auifieldgroup">
                    ...
                    <label for="defaultUserTimeZone"><ww:text name="'admin.timezone.zone'"/></label>
            ...
            <ww:if test="/showExternalLinksInNewWindow == true">
                <page:applyDecorator name="auifieldgroup">
                    <page:param name="description"><ww:text name="'preferences.external.links.new.window.desc'"/></page:param>
                    <aui:select id="'external-links-new-window'" label="text('preferences.external.links.new.window.title')" list="/yesNoList" listKey="'id'" listValue="'name'" name="'externalLinksNewWindow'" theme="'aui'" value="externalLinksNewWindow"/>
                </page:applyDecorator>
            </ww:if>

            <ww:if test="/showQuickSearchingModeSettable == true">
                <page:applyDecorator name="auifieldgroup">
                    <page:param name="description"><ww:text name="'preferences.quicksearch.options.desc'"/></page:param>
                    <aui:select id="'quick-search-preference'" label="text('preferences.quicksearch.title')" list="/quickSearchingModeOptionsList" listKey="'id'" listValue="'name'" name="'quickSearchingMode'" theme="'aui'" value="quickSearchingMode"/>
                </page:applyDecorator>
            </ww:if>
