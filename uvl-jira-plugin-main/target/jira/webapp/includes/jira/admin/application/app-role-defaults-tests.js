AJS.test.require(["jira.webresources:application-roles"], function () {
    ...
    require(["jira/backbone-1.3.3", "jquery"], function (Backbone, $) {
...
AJS.test.require(["jira.webresources:application-roles"], function () {
    ...
    require(["jira/backbone-1.3.3", "jquery", "jira/admin/application/defaults/DialogView"], function (Backbone, $, DialogView) {

        module('DialogView Tests', {
            setup: function setup() {
                this.context = AJS.test.mockableModuleContext();
                this.applicationCollection = mockCollection([{ key: "roleOne" }, { key: "roleTwo" }, { key: "roleThree", defaultGroups: ["defaultGroup"] }]);
...
AJS.test.require(["jira.webresources:application-roles"], function () {
    ...
    require(['jira/backbone-1.3.3', 'jquery', 'wrm/data'], function (Backbone, $, wrmData) {

        module('Defaults init tests', {
            setup: function setup() {
                this.context = AJS.test.mockableModuleContext();
        ...
        test('Init should use provided webpanels to init pluginpoint', function () {
            var claimStub = sinon.stub(wrmData, 'claim');
