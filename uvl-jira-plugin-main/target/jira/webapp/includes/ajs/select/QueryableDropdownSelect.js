define('jira/ajs/select/queryable-dropdown-select', ['jira/util/formatter', 'jira/jquery/deferred', 'jira/ajs/control', 'jira/ajs/select/suggestions/default-suggest-handler', 'jira/ajs/layer/inline-layer-factory', 'jira/ajs/list/list', 'jira/util/key-code', 'jira/util/navigator', 'jira/util/assistive', 'jquery', 'underscore'], function (formatter, Deferred, Control, DefaultSuggestHandler, InlineLayerFactory, List, keyCodes, Navigator, Assistive, jQuery, _) {
    ...
    return Control.extend({
        ...
        _onItemFocus: function _onItemFocus(e, item) {
            ...
            if (!this.options.shouldNotAddAriaAttributesForSearchField) {
        ...
        /**
         * Hides an aria-invalid attribute
         */
        hideAriaInvalid: function hideAriaInvalid() {
            if (this.$field.attr('aria-invalid')) {
                this.$field.removeAttr("aria-invalid");
            }
        },

        /**
         * Hides an aria-describedby attribute
         * Use for remove paired aria-describedby on field with id of an error message
         */
        hideAriaDescribedBy: function hideAriaDescribedBy() {
            if (this.$field.attr('aria-describedby')) {
                this.$field.removeAttr("aria-describedby");
            }
        },
        ...
        showSuggestions: function showSuggestions() {
            ...
            if (!this.options.shouldNotAddAriaAttributesForSearchField) {
                ...
                this.$field.attr("aria-owns", this.suggestionsContainerId);
            }
        },
        ...
        hideSuggestions: function hideSuggestions() {
            ...
            if (!this.options.shouldNotAddAriaAttributesForSearchField) {
                ...
                this.$field.removeAttr("aria-owns");
            }
        },
        ...
        _renders: {
            ...
            field: function field() {
                ...
                if (this.options.ariaDescribedBy) {
                    $field.attr("aria-describedby", this.options.ariaDescribedBy);
                }
            ...
            dropdownAndLoadingIcon: function dropdownAndLoadingIcon(showDropdown) {
                return jQuery('<span class="icon noloading" tabindex="-1"></span>').toggleClass("drop-menu", !!showDropdown);
            },
