                    ...
                    <td id="cell<ww:property value="key"/>" onclick="selectCellRadioBox(this.id)">
                        <div class="field-group">
                            ...
                            <ww:if test="./descriptor/typeManaged == true">
                                <span class="aui-lozenge aui-lozenge-subtle" title="<ww:text name="./descriptor/managedDescriptionKey"/>"><ww:text name="'admin.managed.configuration.items.managed'" /></span>
                            </ww:if>
