...
<%@ page import="com.atlassian.jira.component.pico.ComponentManager" %>
<%@ page import="com.atlassian.jira.web.startup.StartupPageSupport" %>
<%@ page import="com.atlassian.jira.component.ComponentContainerState" %>
<!DOCTYPE html>
<html>
<%
    final ComponentContainerState state = ComponentManager.getInstance().getState();
        ...
        <div class="jira-logo">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 72 72">
                <defs>
                    ...
                    <linearGradient id="New_Gradient_Swatch_1" x1="53.96" y1="17.29" x2="39.25" y2="32.46"
                                    gradientUnits="userSpaceOnUse">
                        <stop offset="0.18" stop-color="#0052cc"/>
                        <stop offset="1" stop-color="#2684ff"/>
                    </linearGradient>
                    <linearGradient id="New_Gradient_Swatch_1-2" x1="37.83" y1="34.62" x2="20.82" y2="51.16"
                ...
                <g id="Layer_2" data-name="Layer 2">
                    <g id="Blue">
                        <path class="cls-2"
                              d="M68.81,0H34.23A15.61,15.61,0,0,0,49.84,15.61h6.37v6.15A15.61,15.61,0,0,0,71.81,37.36V3A3,3,0,0,0,68.81,0Z"/>
                        <path class="cls-3"
                              d="M51.7,17.23H17.12A15.61,15.61,0,0,0,32.72,32.83h6.37V39A15.61,15.61,0,0,0,54.7,54.59V20.23A3,3,0,0,0,51.7,17.23Z"/>
                        <path class="cls-4"
                              d="M34.58,34.45H0A15.61,15.61,0,0,0,15.61,50.06H22v6.15A15.61,15.61,0,0,0,37.58,71.81V37.45A3,3,0,0,0,34.58,34.45Z"/>
                    </g>
                </g>
            </svg>
        </div>
...
<footer>
    <a href="http://www.atlassian.com" target="_blank" rel="noopener noreferrer" class="logo">Atlassian</a>
</footer>
<script>
    (function () {
