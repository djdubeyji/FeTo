define('jira/components/color-picker/color-picker-controller', ['jira/marionette-3.1', 'jira/backbone-1.3.3', 'jira/components/color-picker/view/color-picker-view', 'jira/components/color-picker/sample-color/sample-colors-factory'], function (Marionette, Backbone, ColorPickerView, sampleColorsFactory) {
    "use strict";
