...
<body>
    <page:applyDecorator name="jiraform">
        ...
        <page:param name="leftButtons">
            <ww:if test="/formStatus != 'START' && /formStatus != 'AUTH_FAILURE'">
            ...
            <ww:if test="/formStatus == 'TEST_SUCCESS'">
        ...
        <ww:if test="/actionName == 'VerifySmtpServerConnection' || /actionName == 'PerformOAuth2Authorization'">
        ...
        <div id="projects-with-notification-schemes" class="shared-item-target">
            <div class="shared-item-content">
                <ul class="shared-items-list shared-project-list">
        ...
        <ui:select label="text('admin.mailservers.service.provider')" name="'serviceProvider'" list="/supportedServiceProviders" listKey="'key'" listValue="'value'">
        </ui:select>
        ...
        <ui:select
                label="text('common.words.authentication_method')"
        ...
        <ui:checkbox label="text('common.concepts.enabled')" name="'jndiEnabled'" fieldValue="true"/>
