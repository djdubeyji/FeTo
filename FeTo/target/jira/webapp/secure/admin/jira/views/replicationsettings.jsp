...
<aui:component template="module.jsp" theme="'aui'">
    ...
    <aui:param name="'contentHtml'">
        <table class="aui aui-table-rowhover" id="table-replication-settings">
            ...
            <ww:if test="/replicationEnabled == true">
                <ww:iterator value="/replicableFileTypes" >
                    <tr>
                        <td width="40%" data-cell-type="label">
                            <strong><ww:text name="i18nKey(.)"/></strong>
                        </td>
                        <td width="60%" data-cell-type="value">
                            <ww:if test="/fileTypeEnabled(.) == true">
                                <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                            </ww:if>
                            <ww:else>
                                <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
                ...
                <ww:iterator value="/nonReplicableFileTypes" >
                    <tr>
                        <td width="40%" data-cell-type="label">
                            <strong><ww:text name="i18nKey(./key)"/></strong>
                        </td>
                        <td width="60%" data-cell-type="value">
                            <ww:text name="'admin.replicationsettings.not.in.jira.home'">
                                <ww:param name="value0"><ww:text name="i18nKey(./key)"/></ww:param>
                            </ww:text>
                            <a href="<%= request.getContextPath() %><ww:property value="./value"/>">
                                <ww:text name="'admin.replicationsettings.not.in.jira.home.link.label'"/>
                            </a>
                        </td>
                    </tr>
                </ww:iterator>
