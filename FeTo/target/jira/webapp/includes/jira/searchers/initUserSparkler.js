define('jira/searchers/user-utils', ['jira/ajs/list/group-descriptor', 'jira/ajs/list/item-descriptor', 'underscore', 'wrm/context-path'], function (GroupDescriptor, ItemDescriptor, _, contextPath) {
    'use strict';
...
define('jira/searchers/elements/user-group-sparkler', ['jira/ajs/select/checkbox-multi-select', 'jira/data/parse-options-from-fieldset', 'jira/searchers/user-utils', 'jira/skate', 'jquery', 'wrm/context-path'], function (CheckboxMultiSelect, parseOptionsFromFieldset, utils, skate, $, contextPath) {
    'use strict';
...
define('jira/searchers/elements/user-sparkler', ['jira/ajs/select/checkbox-multi-select', 'jira/searchers/user-utils', 'jira/skate', 'wrm/context-path'], function (CheckboxMultiSelect, utils, skate, contextPath) {
    'use strict';
        ...
        created: function userSparklerCreated(element) {
            new CheckboxMultiSelect({
                ...
                ajaxOptions: {
                    ...
                    formatResponse: function formatResponse(items) {
...
define('jira/searchers/elements/group-sparkler', ['jira/ajs/select/checkbox-multi-select', 'jira/searchers/user-utils', 'jira/skate', 'wrm/context-path'], function (CheckboxMultiSelect, utils, skate, contextPath) {
    'use strict';
