define('jira/project/edit-project-details', ['jquery', 'jira/backbone-1.3.3', 'jira/project/edit/project-type-field', 'jira/project/edit/project-category-field', 'internal/browser-metrics'], function ($, Backbone, ProjectTypeField, ProjectCategoryField, metrics) {
    'use strict';
