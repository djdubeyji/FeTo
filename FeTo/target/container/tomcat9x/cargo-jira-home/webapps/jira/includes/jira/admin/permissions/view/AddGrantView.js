define('jira/project/permissions/addgrantview', ['jira/util/formatter', 'jira/field/user-picker-util', 'jira/field/group-picker-util', 'jira/ajs/list/item-descriptor', 'jira/backbone-1.3.3', 'underscore', 'jquery', 'jira/ajs/select/single-select', 'jira/project/permissions/securitytypes', 'jira/field/role-picker-util', 'wrm/context-path'], function (formatter, UserPickerUtil, GroupPickerUtil, ItemDescriptor, Backbone, _, $, SingleSelect, SecurityTypes, rolepicker, wrmContextPath) {
    "use strict";
        ...
        renderInput: function renderInput() {
            ...
            switch (this.model.get("securityType")) {
                ...
                case SecurityTypes.PROJECT_ROLE:
                    groupSelectTemplate = JIRA.Templates.AddProjectPermission.renderSelect({
...
define('jira/project/permissions/addgrantcollectionview', ['jira/backbone-1.3.3', 'underscore', 'jira/project/permissions/addgrantview'], function (Backbone, _, AddGrantView) {
    "use strict";
