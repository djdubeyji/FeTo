 ...
 */
define("jira/issuetable/dnd", ["jquery", "jira/backbone-1.3.3", "jira/featureflags/feature-manager", "jira/deprecator", "underscore"], function ($, Backbone, featureManager, deprecator, _) {
    'use strict';
    ...
    var enhancedTable = function enhancedTable(element) {
        var table = _.extend({
            element: element,
