define('jira/project/permissions/permissionschemeview', ['jira/util/formatter', 'jira/backbone-1.3.3', 'underscore', 'internal/browser-metrics', 'jira/project/permissions/permissiongroupview', 'jira/project/permissions/addpermissionmodel', 'jira/project/permissions/addpermissionview', 'jira/project/permissions/deletepermissionview', 'jira/flag'], function (formatter, Backbone, _, metrics, PermissionsGroupView, AddPermissionModel, AddPermissionView, DeletePermissionView, jiraFlag) {
    "use strict";
