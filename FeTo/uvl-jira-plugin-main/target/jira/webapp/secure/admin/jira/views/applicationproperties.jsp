...
<body>
    ...
    <table class="aui">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><a href="<ww:property value="applicationProperties/string('jira.baseurl')"/>" target="_blank" rel="noopener noreferrer"><ww:property value="applicationProperties/string('jira.baseurl')"/></a></td>
            </tr>
            <tr>
    ...
    <table class="aui" id="options_table">
        ...
        <tbody>
            ...
            <tr>
                <td><b><ww:text name="'admin.generalconfiguration.allow.public.sharing'"/></b></td>
                <td>
                    <ww:if test="applicationProperties/option('jira.option.globalsharing') == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr data-property-id="project-description-mode">
                <td><b><ww:text
                        name="'admin.generalconfiguration.project.description.html.enabled.label'"></ww:text></b></td>
                <td><strong>
            ...
            <tr>
                <td><b><ww:text name="'admin.generalconfiguration.custom.field.html.enabled.label'"></ww:text></b></td>
                <td>
                    <ww:if test="/customFieldHtmlEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr>
                <td><b><ww:text name="'admin.generalconfiguration.empty.jql.returns.no.data.label'"></ww:text></b></td>
                <td>
                    <ww:if test="/emptyJqlReturnsNoDataEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr>
                <td><b><ww:text name="'admin.generalconfiguration.csv.export.dialog.enabled.label'"></ww:text></b></td>
                <td>
                    <ww:if test="/csvExportDialogEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr>
                <td><strong><ww:text name="'admin.generalconfiguration.favourite.filters.jql.execution.timeout.label'"></ww:text></strong></td>
                <td data-property-id="favouriteFiltersGadgetMaxTimeout"><ww:property value="applicationProperties/defaultBackedString('admin.generalconfiguration.favourite.filters.jql.execution.timeout')" /></td>
            </tr>
            <tr data-test-id="xsrf-dialog-params-display">
                <td><b><ww:text name="'admin.generalconfiguration.xsrf.dialog.urlparams.display.label'"></ww:text></b></td>
                <td>
                    <ww:if test="/xsrfDialogDisplayParamsEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr data-test-id="issue-view-comment-reactions">
                <td><b><ww:text name="'admin.generalconfiguration.enable.issue.comment.reactions.label'"></ww:text></b></td>
                <td>
                    <ww:if test="/issueCommentReactionsEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
                    <ww:else>
                        <strong class="status-inactive"><ww:text name="'admin.common.words.off'"/></strong>
            ...
            <tr>
                <td><b><ww:text name="'admin.generalconfiguration.stacktrace'"></ww:text></b></td>
                <td>
                    <ww:if test="/stackTraceEnabled == true">
                        <strong class="status-active"><ww:text name="'admin.common.words.on'"/></strong>
                    </ww:if>
