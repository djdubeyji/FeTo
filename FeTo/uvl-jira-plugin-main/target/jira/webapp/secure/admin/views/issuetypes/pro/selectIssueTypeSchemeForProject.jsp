...
<body>
	...
	<page:applyDecorator name="jiraform">
		...
		<page:param name="instructions">
            ...
            <p>
                <ww:if test="/subTaskIssuesCount > 0">
                    <ww:text name="'admin.projects.issuetypescheme.there.are.current.issues.long'">
                        <ww:param name="'value0'"><strong><ww:property value="/standardIssuesCount" /></strong></ww:param>
                        <ww:param name="'value1'"><strong><ww:property value="/subTaskIssuesCount" /></strong></ww:param>
                    </ww:text>
                </ww:if>
                <ww:else>
