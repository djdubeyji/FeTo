define('jira/project/browse/app', ['jira/backbone-1.3.3', 'jira/marionette-4.1', 'jira/util/navigation', 'jira/project/browse/layout', 'jira/project/browse/projectcollection', 'jira/project/browse/filtermodel', 'jira/project/browse/categorycollection', 'jira/project/browse/projecttypecollection', 'jira/project/browse/router'], function (Backbone, Marionette, Navigation, Layout, ProjectCollection, FilterModel, CategoryCollection, ProjectTypeCollection, Router) {
    'use strict';
