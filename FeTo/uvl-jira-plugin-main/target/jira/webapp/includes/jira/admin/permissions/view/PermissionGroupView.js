define('jira/project/permissions/permissiongroupview', ['jira/backbone-1.3.3', 'jira/project/permissions/permissionrowview', 'underscore', 'jira/project/permissions/securitytypes'], function (Backbone, PermissionRowView, _, SecurityTypes) {
    "use strict";
