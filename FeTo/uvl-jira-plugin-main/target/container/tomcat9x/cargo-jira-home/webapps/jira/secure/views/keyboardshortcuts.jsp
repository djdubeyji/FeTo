...
<body>
    <page:applyDecorator id="update-keyboard-shortcuts" name="auiform">
        ...
        <div id="shortcutsmenu" class="scrollable" aria-label="<ww:text name="'keyboard.shortcuts.title'"/>" role="region" tabindex="0">
                    ...
                    <div class="mod-content">
                        <ul class="item-details">
                                ...
                                <ww:if test="./hidden == false">
                                    <li>
                                        <dl>
                                            ...
                                            <dd>
                                                <ww:if test="./descriptionI18nKey == 'admin.keyboard.shortcut.navigator.view.issue.desc'"><ww:property value="./prettyShortcut(/i18nHelper)" escape="false" /> <ww:text name="'common.words.or'"/> <kbd>Enter</kbd></ww:if>
                            ...
                            <ww:if test="./toString() == 'global'">
                                ...
                                <li>
                                    <dl>
                                        <dt><ww:text name="'common.forms.editor.submit.help.label'"/>:</dt>
                                        <dd>
                                            <ww:iterator value="/editorSubmitKeys" status="'status'">
                                                <kbd><ww:property value="." escape="false"/></kbd><ww:if test="@status/last == false"> + </ww:if>
                                            </ww:iterator>
                                        </dd>
                                    </dl>
                                </li>
