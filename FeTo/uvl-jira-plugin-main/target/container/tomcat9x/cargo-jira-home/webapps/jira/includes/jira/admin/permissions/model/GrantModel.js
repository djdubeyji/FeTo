define('jira/project/permissions/grantmodel', ['jira/backbone-1.3.3', 'underscore', 'jira/project/permissions/securitytypes'], function (Backbone, _, SecurityTypes) {
    "use strict";
...
define('jira/project/permissions/grantcollection', ['jira/backbone-1.3.3', 'underscore', 'jira/project/permissions/grantmodel'], function (Backbone, _, GrantModel) {
    "use strict";
    ...
    return Backbone.Collection.extend({
        ...
        getSelectedModel: function getSelectedModel() {
            return this.find(function (grantModel) {
                return grantModel.get("selected");
            });
        }
    });
});