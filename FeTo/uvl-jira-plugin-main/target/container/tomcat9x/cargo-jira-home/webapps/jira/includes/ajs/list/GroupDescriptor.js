/**
 * @module jira/ajs/list/group-descriptor
 */
define('jira/ajs/list/group-descriptor', ['jira/ajs/descriptor'], function (Descriptor) {
    'use strict';
    ...
    return Descriptor.extend({
         ...
         * We use fetchedThroughAjaxCall value to distinguish GroupDescriptors created
         * in consequence of AJAX call with a query {@link SuggestionHandlers@formatSuggestions}
         *
         * @return {Object}
         */
        ...
        /**
         * Returns true if the instance was created in response handler from AJAX query call
         * @return {boolean}
         */
        fetchedThroughAjaxCall: function fetchedThroughAjaxCall() {
            return this.properties.fetchedThroughAjaxCall;
        },
