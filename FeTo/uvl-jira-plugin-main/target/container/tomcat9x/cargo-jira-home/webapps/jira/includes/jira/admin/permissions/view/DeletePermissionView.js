define('jira/project/permissions/deletepermissionview', ['jira/util/formatter', 'jira/backbone-1.3.3', 'jquery', 'underscore', 'jira/project/permissions/securitytypes', "wrm/context-path"], function (formatter, Backbone, $, _, SecurityTypes, wrmContextPath) {
    "use strict";
    ...
    return Backbone.View.extend({
        ...
        open: function open() {
            this.dialog.show();
            this.dialog.on('hide', _.bind(this._close, this));
            this.render();
