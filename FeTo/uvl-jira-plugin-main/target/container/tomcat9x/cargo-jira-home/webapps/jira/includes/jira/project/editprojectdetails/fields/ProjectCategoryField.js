define('jira/project/edit/project-category-field', ['jquery', 'jira/ajs/select/single-select', 'jira/backbone-1.3.3', 'aui/inline-dialog2'], function ($, SingleSelect, Backbone) {
    'use strict';
