define('jira/project/permissions/grantsview', ['jira/util/formatter', 'jira/backbone-1.3.3', 'underscore', 'jira/project/permissions/securitytypes'], function (formatter, Backbone, _, SecurityTypes) {
    "use strict";
