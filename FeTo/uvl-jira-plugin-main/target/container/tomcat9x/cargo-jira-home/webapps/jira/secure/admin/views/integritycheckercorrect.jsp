...
<page:applyDecorator name="jiraform">
    ...
    <page:param name="buttons">
        <input class="aui-button" type="submit" name="back" value="<ww:text name="'admin.common.words.ok'"/>"/>
    </page:param>
                    ...
                    <ww:iterator value="./checks">
                        <li>
                            ...
                            <ww:else>
                                ...
                                <ww:if test="/results/(./id) != null && /results/(./id)/empty == false">
                                    <ww:if test="/hasWarningResults(./id) == true">
