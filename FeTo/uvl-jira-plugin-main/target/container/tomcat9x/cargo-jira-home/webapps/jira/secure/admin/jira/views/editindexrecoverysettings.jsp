...
<form method="post" id="edit-service" class="aui" name="jiraform" action="EditIndexRecoverySettings.jspa">
    ...
    <div class="buttons-container">
        <input class="aui-button" type="submit" id="updateButton" name="<ww:text name="'common.forms.update'"/>" value="<ww:text name="'common.forms.update'"/>" onclick="location.href='IndexAdmin.jspa'" />
